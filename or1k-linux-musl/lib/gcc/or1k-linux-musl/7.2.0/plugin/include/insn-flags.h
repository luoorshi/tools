...
#define HAVE_frame_alloc 1
#define HAVE_sne_sr_cy 1
#define HAVE_sltu_sr_cy 1
#define HAVE_sgeui_sr_cy 1
...
#define HAVE_adddi_int 1
#define HAVE_subdi_int 1
#define HAVE_addsi_co (reload_completed)
#define HAVE_addsi_ci (reload_completed)
#define HAVE_subsi_co (reload_completed)
#define HAVE_jump 1
...
#define HAVE_return (or1k_direct_return ())
...
#define HAVE_cstoresf4 (TARGET_CMOV && TARGET_HARD_FLOAT)
...
extern rtx        gen_frame_alloc               (rtx, rtx, rtx);
extern rtx        gen_sne_sr_cy                 (rtx, rtx);
extern rtx        gen_sltu_sr_cy                (rtx, rtx, rtx);
extern rtx        gen_sgeui_sr_cy               (rtx, rtx, rtx);
...
extern rtx        gen_adddi_int                 (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_subdi_int                 (rtx, rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_addsi_co                  (rtx, rtx, rtx);
extern rtx        gen_addsi_ci                  (rtx, rtx, rtx);
extern rtx        gen_subsi_co                  (rtx, rtx, rtx);
