/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc/config/or1k/or1k.md'.  */
...
extern int reg_or_s16_operand (rtx, machine_mode);
extern int reg_or_u16_operand (rtx, machine_mode);
extern int shift_operand (rtx, machine_mode);
extern int sgeui_operand (rtx, machine_mode);
