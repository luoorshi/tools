...
#define MASK_CMOV (1U << 0)
#define MASK_HARD_DIV (1U << 1)
#define MASK_HARD_FLOAT (1U << 2)
#define MASK_HARD_MUL (1U << 3)
#define MASK_PADSTRUCT (1U << 4)
#define MASK_ROR (1U << 5)
#define MASK_SEXT (1U << 6)

#define TARGET_CMOV ((target_flags & MASK_CMOV) != 0)
#define TARGET_CMOV_P(target_flags) (((target_flags) & MASK_CMOV) != 0)
#define TARGET_HARD_DIV ((target_flags & MASK_HARD_DIV) != 0)
#define TARGET_HARD_DIV_P(target_flags) (((target_flags) & MASK_HARD_DIV) != 0)
#define TARGET_HARD_FLOAT ((target_flags & MASK_HARD_FLOAT) != 0)
#define TARGET_HARD_FLOAT_P(target_flags) (((target_flags) & MASK_HARD_FLOAT) != 0)
#define TARGET_HARD_MUL ((target_flags & MASK_HARD_MUL) != 0)
#define TARGET_HARD_MUL_P(target_flags) (((target_flags) & MASK_HARD_MUL) != 0)
#define TARGET_PADSTRUCT ((target_flags & MASK_PADSTRUCT) != 0)
#define TARGET_PADSTRUCT_P(target_flags) (((target_flags) & MASK_PADSTRUCT) != 0)
#define TARGET_ROR ((target_flags & MASK_ROR) != 0)
#define TARGET_ROR_P(target_flags) (((target_flags) & MASK_ROR) != 0)
#define TARGET_SEXT ((target_flags & MASK_SEXT) != 0)
#define TARGET_SEXT_P(target_flags) (((target_flags) & MASK_SEXT) != 0)
...
enum opt_code
{
  ...
  OPT_fipa_sem_equality = 738,               /* -fipa-sem-equality */
  OPT_fipa_sra = 739,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 740, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 741,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 742,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 743,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 744,              /* -fira-loop-pressure */
  OPT_fira_region_ = 745,                    /* -fira-region= */
  OPT_fira_share_save_slots = 746,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 747,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 748,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 749,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 750,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 751,               /* -fivar-visibility= */
  OPT_fivopts = 752,                         /* -fivopts */
  OPT_fjump_tables = 753,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 754,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 755,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 756,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 757,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 758,          /* -fkeep-static-functions */
  ...
  OPT_flifetime_dse_ = 763,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 764,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 765,                 /* -flinker-output= */
  ...
  OPT_fnew_inheriting_ctors = 808,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 809,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 810,                   /* -fnext-runtime */
  OPT_fnil_receivers = 811,                  /* -fnil-receivers */
  ...
  OPT_fopenacc_dim_ = 828,                   /* -fopenacc-dim= */
  OPT_fopenmp = 829,                         /* -fopenmp */
  OPT_fopenmp_simd = 830,                    /* -fopenmp-simd */
  OPT_foperator_names = 831,                 /* -foperator-names */
  OPT_fopt_info = 832,                       /* -fopt-info */
  OPT_fopt_info_ = 833,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 834, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 835,         /* -foptimize-sibling-calls */
  ...
  OPT_fpermitted_flt_eval_methods_ = 849,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 850,                            /* -fpic */
  OPT_fpie = 851,                            /* -fpie */
  OPT_fplan9_extensions = 852,               /* -fplan9-extensions */
  OPT_fplt = 853,                            /* -fplt */
  OPT_fplugin_arg_ = 854,                    /* -fplugin-arg- */
  OPT_fplugin_ = 855,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 856,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 857,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 858,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 859,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 860,                   /* -fpreprocessed */
  OPT_fpretty_templates = 861,               /* -fpretty-templates */
  OPT_fprintf_return_value = 862,            /* -fprintf-return-value */
  OPT_fprofile = 863,                        /* -fprofile */
  OPT_fprofile_arcs = 864,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 865,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 866,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 867,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 868,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 869,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 870,                 /* -fprofile-report */
  OPT_fprofile_update_ = 871,                /* -fprofile-update= */
  OPT_fprofile_use = 872,                    /* -fprofile-use */
  OPT_fprofile_use_ = 873,                   /* -fprofile-use= */
  OPT_fprofile_values = 874,                 /* -fprofile-values */
  OPT_fprotect_parens = 875,                 /* -fprotect-parens */
  OPT_frandom_seed = 876,                    /* -frandom-seed */
  OPT_frandom_seed_ = 877,                   /* -frandom-seed= */
  OPT_frange_check = 878,                    /* -frange-check */
  OPT_freal_4_real_10 = 879,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 880,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 881,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 882,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 883,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 884,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 885,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 886,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 887,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 888,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 889,                /* -frecord-marker=8 */
  OPT_frecursive = 890,                      /* -frecursive */
  OPT_free = 891,                            /* -free */
  OPT_freg_struct_return = 892,              /* -freg-struct-return */
  /* OPT_fregmove = 893, */                  /* -fregmove */
  OPT_frename_registers = 894,               /* -frename-registers */
  OPT_freorder_blocks = 895,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 896,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 897,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 898,              /* -freorder-functions */
  OPT_frepack_arrays = 899,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 900,           /* -freplace-objc-classes */
  OPT_frepo = 901,                           /* -frepo */
  OPT_freport_bug = 902,                     /* -freport-bug */
  OPT_frequire_return_statement = 903,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 904,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 905, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 906,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 907,                    /* -fresolution= */
  OPT_frounding_math = 908,                  /* -frounding-math */
  OPT_frtti = 909,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 910,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_trace_pc = 911,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 912,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 913,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 914,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 915,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 916,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 917,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 918,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 919,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 920,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 921,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 922,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 923,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 924,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 925,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 926,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 927,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 928,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 929,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 930,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 931,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 932,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 933,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 934, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 935,                /* -fschedule-fusion */
  OPT_fschedule_insns = 936,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 937,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 938,              /* -fsecond-underscore */
  OPT_fsection_anchors = 939,                /* -fsection-anchors */
  /* OPT_fsee = 940, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 941,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 942,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 943, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 944,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 945,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 946,                     /* -fself-test= */
  OPT_fsemantic_interposition = 947,         /* -fsemantic-interposition */
  OPT_fshort_enums = 948,                    /* -fshort-enums */
  OPT_fshort_wchar = 949,                    /* -fshort-wchar */
  OPT_fshow_column = 950,                    /* -fshow-column */
  OPT_fshrink_wrap = 951,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 952,           /* -fshrink-wrap-separate */
  OPT_fsign_zero = 953,                      /* -fsign-zero */
  OPT_fsignaling_nans = 954,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 955,               /* -fsigned-bitfields */
  OPT_fsigned_char = 956,                    /* -fsigned-char */
  OPT_fsigned_zeros = 957,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 958,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 959,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 960,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 961,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 962,                    /* -fsplit-loops */
  OPT_fsplit_paths = 963,                    /* -fsplit-paths */
  OPT_fsplit_stack = 964,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 965,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 966, */                 /* -fsquangle */
  OPT_fssa_backprop = 967,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 968,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 969,                    /* -fsso-struct= */
  OPT_fstack_arrays = 970,                   /* -fstack-arrays */
  /* OPT_fstack_check = 971, */              /* -fstack-check */
  OPT_fstack_check_ = 972,                   /* -fstack-check= */
  OPT_fstack_limit = 973,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 974,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 975,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 976,                /* -fstack-protector */
  OPT_fstack_protector_all = 977,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 978,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 979,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 980,                   /* -fstack-reuse= */
  OPT_fstack_usage = 981,                    /* -fstack-usage */
  OPT_fstats = 982,                          /* -fstats */
  OPT_fstdarg_opt = 983,                     /* -fstdarg-opt */
  OPT_fstore_merging = 984,                  /* -fstore-merging */
  /* OPT_fstrength_reduce = 985, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 986,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 987,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 988,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 989, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 990,      /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 991, */        /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 992,             /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 993,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 994,                    /* -fsyntax-only */
  OPT_ftabstop_ = 995,                       /* -ftabstop= */
  /* OPT_ftarget_help = 996, */              /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 997,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 998, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 999,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 1000,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1001,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1002, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1003,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1004,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1005,                   /* -ftime-report */
  OPT_ftime_report_details = 1006,           /* -ftime-report-details */
  OPT_ftls_model_ = 1007,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1008,              /* -ftoplevel-reorder */
  OPT_ftracer = 1009,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1010,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1011,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1012,                   /* -ftrampolines */
  OPT_ftrapping_math = 1013,                 /* -ftrapping-math */
  OPT_ftrapv = 1014,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1015,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1016,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1017,                      /* -ftree-ccp */
  OPT_ftree_ch = 1018,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1019, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1020,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1021,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1022, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1023,                   /* -ftree-cselim */
  OPT_ftree_dce = 1024,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1025,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1026,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1027,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1028,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1029, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1030,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1031,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1032, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1033,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1034,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1035, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1036,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1037,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1038,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1039,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1040,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1041,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1042,                      /* -ftree-pre */
  OPT_ftree_pta = 1043,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1044,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1045, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1046,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1047,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1048,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1049,                     /* -ftree-slsr */
  OPT_ftree_sra = 1050,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1051, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1052, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1053,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1054,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1055,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1056, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1057,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1058, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1059,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1060,         /* -funconstrained-commons */
  OPT_funderscoring = 1061,                  /* -funderscoring */
  OPT_funit_at_a_time = 1062,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1063,              /* -funroll-all-loops */
  OPT_funroll_loops = 1064,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1065, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1066,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1067,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1068,                 /* -funsigned-char */
  OPT_funswitch_loops = 1069,                /* -funswitch-loops */
  OPT_funwind_tables = 1070,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1071,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1072,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1073,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1074,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1075,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1076,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1077,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1078,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1079,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1080,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1081, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1082,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1083,                   /* -fverbose-asm */
  /* OPT_fversion = 1084, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1085,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1086,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1087,                   /* -fvisibility= */
  OPT_fvpt = 1088,                           /* -fvpt */
  /* OPT_fvtable_gc = 1089, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1090, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1091,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1092,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1093,                     /* -fvtv-debug */
  OPT_fweak = 1094,                          /* -fweak */
  OPT_fweb = 1095,                           /* -fweb */
  /* OPT_fwhole_file = 1096, */              /* -fwhole-file */
  OPT_fwhole_program = 1097,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1098,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1099,             /* -fworking-directory */
  OPT_fwpa = 1100,                           /* -fwpa */
  OPT_fwpa_ = 1101,                          /* -fwpa= */
  OPT_fwrapv = 1102,                         /* -fwrapv */
  /* OPT_fxref = 1103, */                    /* -fxref */
  /* OPT_fzee = 1104, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1105,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1106,                     /* -fzero-link */
  OPT_g = 1107,                              /* -g */
  OPT_gant = 1108,                           /* -gant */
  OPT_gcoff = 1109,                          /* -gcoff */
  OPT_gcolumn_info = 1110,                   /* -gcolumn-info */
  OPT_gdwarf = 1111,                         /* -gdwarf */
  OPT_gdwarf_ = 1112,                        /* -gdwarf- */
  OPT_gen_decls = 1113,                      /* -gen-decls */
  OPT_ggdb = 1114,                           /* -ggdb */
  OPT_ggnu_pubnames = 1115,                  /* -ggnu-pubnames */
  OPT_gnat = 1116,                           /* -gnat */
  OPT_gnatO = 1117,                          /* -gnatO */
  OPT_gno_column_info = 1118,                /* -gno-column-info */
  OPT_gno_pubnames = 1119,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1120,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1121,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1122,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1123,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1124,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1125,                   /* -gsplit-dwarf */
  OPT_gstabs = 1126,                         /* -gstabs */
  OPT_gstabs_ = 1127,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1128,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1129,                        /* -gtoggle */
  OPT_gvms = 1130,                           /* -gvms */
  OPT_gxcoff = 1131,                         /* -gxcoff */
  OPT_gxcoff_ = 1132,                        /* -gxcoff+ */
  OPT_gz = 1133,                             /* -gz */
  OPT_gz_ = 1134,                            /* -gz= */
  OPT_h = 1135,                              /* -h */
  OPT_idirafter = 1136,                      /* -idirafter */
  OPT_imacros = 1137,                        /* -imacros */
  OPT_imultiarch = 1138,                     /* -imultiarch */
  OPT_imultilib = 1139,                      /* -imultilib */
  OPT_include = 1140,                        /* -include */
  OPT_iplugindir_ = 1141,                    /* -iplugindir= */
  OPT_iprefix = 1142,                        /* -iprefix */
  OPT_iquote = 1143,                         /* -iquote */
  OPT_isysroot = 1144,                       /* -isysroot */
  OPT_isystem = 1145,                        /* -isystem */
  OPT_iwithprefix = 1146,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1147,              /* -iwithprefixbefore */
  OPT_k8 = 1148,                             /* -k8 */
  OPT_l = 1149,                              /* -l */
  OPT_lang_asm = 1150,                       /* -lang-asm */
  OPT_mbionic = 1151,                        /* -mbionic */
  OPT_mboard_ = 1152,                        /* -mboard= */
  OPT_mcmov = 1153,                          /* -mcmov */
  OPT_mcompat_delay = 1154,                  /* -mcompat-delay */
  OPT_mdelay = 1155,                         /* -mdelay */
  OPT_mglibc = 1156,                         /* -mglibc */
  OPT_mhard_div = 1157,                      /* -mhard-div */
  OPT_mhard_float = 1158,                    /* -mhard-float */
  OPT_mhard_mul = 1159,                      /* -mhard-mul */
  OPT_mmusl = 1160,                          /* -mmusl */
  OPT_mnewlib = 1161,                        /* -mnewlib */
  OPT_mno_delay = 1162,                      /* -mno-delay */
  OPT_mpadstruct = 1163,                     /* -mpadstruct */
  OPT_mredzone_ = 1164,                      /* -mredzone= */
  OPT_mror = 1165,                           /* -mror */
  OPT_msext = 1166,                          /* -msext */
  OPT_msoft_div = 1167,                      /* -msoft-div */
  OPT_msoft_float = 1168,                    /* -msoft-float */
  OPT_msoft_mul = 1169,                      /* -msoft-mul */
  OPT_muclibc = 1170,                        /* -muclibc */
  OPT_n = 1171,                              /* -n */
  OPT_no_canonical_prefixes = 1172,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1173,              /* -no-integrated-cpp */
  OPT_no_pie = 1174,                         /* -no-pie */
  ...
  OPT_pie = 1187,                            /* -pie */
  OPT_pipe = 1188,                           /* -pipe */
  OPT_posix = 1189,                          /* -posix */
  OPT_print_file_name_ = 1190,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1191,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1192,          /* -print-multi-directory */
  OPT_print_multi_lib = 1193,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1194,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1195,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1196,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1197,               /* -print-prog-name= */
  OPT_print_search_dirs = 1198,              /* -print-search-dirs */
  OPT_print_sysroot = 1199,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1200,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1201,                        /* -profile */
  OPT_pthread = 1202,                        /* -pthread */
  OPT_quiet = 1203,                          /* -quiet */
  OPT_r = 1204,                              /* -r */
  OPT_rdynamic = 1205,                       /* -rdynamic */
